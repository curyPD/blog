  ...
  return (
    <article className="mb-6 flex max-w-md gap-6 rounded-md bg-white p-4 pr-8 shadow-sm last:mb-0">
      <div className="shrink-0 overflow-hidden rounded-md">
        <img src={image} alt="" className="h-24 w-auto object-cover" />
      </div>
      <div className="flex flex-col justify-between">
        <h4 className="mt-1 cursor-pointer font-sans text-base font-bold leading-snug text-gray-700 transition-colors duration-200 hover:text-blue-700 md:text-lg md:leading-snug">
          <Link to="/">How to learn a language in 6 months</Link>
        </h4>
