...
function HeroSection({ sText, hText, pText, buttonText, clickHandler }) {
  return (
    <section className="bg-white bg-gradient-to-t from-blue-50 py-12 md:py-14 xl:py-16">
      <div className="px-4 text-center sm:px-9 md:container md:mx-auto md:text-left xl:max-w-screen-xl">
        ...
        <h1 className="mb-4 font-serif text-2xl font-semibold leading-tight text-gray-800 sm:text-3xl md:w-2/3 lg:mb-5 lg:w-1/2 lg:text-4xl xl:mb-7 xl:text-5xl">
          {hText}
        </h1>
        <p className="mb-5 text-xs text-gray-700 sm:text-sm md:w-2/3 lg:mb-6 lg:w-1/2 lg:text-base xl:mb-8 xl:text-lg">
          {pText}
        </p>
        <button
