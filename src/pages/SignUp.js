    ...
    <section className="p-5 pt-8 sm:pt-12 md:pt-16">
      ...
      >
        ...
        <input
          ...
          className="placeholder:gray-400 mb-4 block w-full rounded-md border border-gray-300 bg-white  py-2 px-3 font-sans text-xs text-gray-700 shadow-sm  focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500  sm:text-sm"
          type="text"
          id="userName"
